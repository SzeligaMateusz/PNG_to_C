...
# This code in the bin.py file except pillow is for everyone, just make sure you follow the HPND license,
...
# 4. Copy the contents of the file and Ctrl-V to your arduino project.                            #
#-------------------------------------------------------------------------------------------------#
